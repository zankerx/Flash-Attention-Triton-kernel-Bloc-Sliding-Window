...
def _fwd_kernel(
    ...
    Z, H, N_CTX,
    BS: tl.constexpr, WS: tl.constexpr,
    ...
    # Constraint : BS % BLOCK_M == 0 and BS % BLOC_N == 0

    B_id = (start_m * BLOCK_M)//BS #Bloc Id

    lo = (B_id - WS + 1)*BS #start column
    hi = lo + WS*BS #end column
    lo = lo if lo >= 0 else 0 #adjust if lo < 0
...
class _attention(torch.autograd.Function):
    ...
    def forward(ctx, q, k, v, bs, ws, sm_scale):
        # shape constraints
